...
sudo scutil --set ComputerName "JL"
sudo scutil --set HostName "JL"
sudo scutil --set LocalHostName "JL"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "JL"
...
systemsetup -settimezone "Europe/Vilnius" > /dev/null
